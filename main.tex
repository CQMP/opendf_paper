...
The rest of this paper is organized as follows: Section~\ref{sec:meth} introduces the methodology. Section~\ref{sec:imp} describes  implementation aspects, section~\ref{sec:perf} performance aspects, section~\ref{sec:ex} shows some examples, and section \ref{sec:conclusions} will conclude.
...
\caption{Momentum Dependence of the lattice self-energy at $U/t = 8$ along the $(k_x,k_y) = (0,0)\to(\pi,0)\to(\pi,\pi)\to(0,0)$ path.}
\label{fig:sigma}
\end{figure}
