...
\caption{Left: $\chi^{\mathrm{ch}}$ and $\chi^{\mathrm{sp}}$, the static spin and charge susceptibilities, at $\Omega = 0$. Right: Colormap plot of $\chi^{\mathrm{sp}}$ as a function of $Q_x$ and $Q_y$. }
\label{fig:susc}
\end{figure}
